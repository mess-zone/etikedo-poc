...
const { isPlaying, currentTime, duration } = storeToRefs(audioStore)
...
function togglePlay() {
    if(audioStore.media.paused) {
        audioStore.media.play()
    } else {
        audioStore.media.pause()
    }
}

function handleChange(value: number) {
    audioStore.media.currentTime = value
}
</script>
<style scoped>
.bottom-controls {
